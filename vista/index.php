        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="#" onclick="cargar_contenido('contenido_principal','usuario/vista_requerimientos_admin.php')">Ver todo</a></li>
            </ul>
          </li>
          <?php 
          }
       ...
       <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href = # onclick="cargar_contenido('contenido_principal','presupuesto/vista_presupuesto.php')"><i class="fa fa-file-text-o"></i>Estado presupuesto</a></li>
        ...
        <li class="treeview">
          ...
          <li><a href = # onclick="cargar_contenido('contenido_principal','encuesta1/vista_encuesta1_listar.php')"><i class="fa fa-file-text-o"></i> Encuesta vecino</a></li>
          </ul>
