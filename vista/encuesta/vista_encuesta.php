...
<form autocomplete="false" onsubmit="return false" id="form-encuesta-detalle">
    <div class="modal fade" id="modal_edit" role="dialog">
        ...
        <div class="modal-content" style="width: 100%;align-items: center;">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 style="text-align:center;" class="modal-title"><b>★Detalle de la encuesta★</b></h4><br>
            <hr>   
            <h5>Modificar las preguntas, considerando:<br>
            ...
            <h3 style="text-align:center;">ÍTEM (A)</h3>
                ...
                <div class="encuesta_detalle">
                    <input type="text" id="idusuario" hidden ><br>
                    <input type="text" id="txt_p1" hidden>
                    <label for="">1.-Información sobre los trabajos a realizar.</label><br>
                ...
                <div class="encuesta_detalle">
                    <input type="text" id="txt_p7" hidden>
                    <label for="">¿Qué aspectos de Trato Hecho Vecino destacarías y qué aspectos sugieres mejorar</label><br><br>
