...
function listar_herramienta() {
    tableherramienta = $("#tabla_herramienta").DataTable({
        ...
        "processing": true,
        "ajax": {
            "url": "../controlador/herramienta/controlador_herramienta_listar_tr.php",
            type: 'POST'
        },
        "order": [
            [1, 'asc']
...
function Registrar_Herramienta() {
    ...
    $.ajax({
        "url": "../controlador/herramienta/controlador_herramienta_registro_tr.php", //URL CON LA DIRECCION DEL CONTROLADOR
        type: 'POST',
        data: {
...
function Modificar_Herramienta() {
    ...
    $.ajax({
        "url": "../controlador/herramienta/controlador_herramienta_modificar_tr.php",
        type: 'POST',
        data: {
            id: id,
            acse: serialactual,
