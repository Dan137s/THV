...
function listar_reparacion() {
    tablereparacion = $("#tabla_reparacion").DataTable({
        ...
        "columns": [
            ...
            { "defaultContent": "<button style='font-size:13px;' &nbsp;<button style='font-size:13px;' type='button' class='imprimir btn btn-danger' title='Imprimir'><i class='fa fa-print'></i></button>" }
        ],
